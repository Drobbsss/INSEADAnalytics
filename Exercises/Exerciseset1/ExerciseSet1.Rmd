...
<br>
1. source("dataSet1.R")
2. Cumulative returns of Apple = 574.8%
   Average daily return of Apple = 0.148%
   Standard deviation of daily returns of Apple = 2.425%
3. Cumulative returns of Yahoo = 275.1%
   Average daily return of Yahoo = 0.071%
   Standard deviation of daily returns of Yahoo = 3.064%
<hr>
<hr>
...
<br>
<br>
1.dim(transposedData)
2.portfolio = apply(transposedData,2,mean)
  names(portfolio) <- rownames(StockReturns)
  pnl_plot(portfolio)
<hr>
<hr>
...
2. website_used = "yahoo"
   mytickers = c("SPY", "AAPL","GOOG","MSFT")
...
<br>
<br>
1. R will return number of rows.
<hr>
<hr>
